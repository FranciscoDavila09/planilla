...
//Get para listar los feriados
  ...
  //Get para obtener feriados por el id 
    ...
    async obtenerPorId(id) {
        return await ejecutarConsulta("SELECT * FROM `dbplanilla`.`feriados` WHERE `IdFeriado` = ?",
             [id]);
...
return await ejecutarConsulta("DELETE FROM dbplanilla.feriados WHERE IdFeriado = ?", [id]);
